...
import numpy as np
from TSolver import TsolverSidecarThread
from TSolver import TsolverThread
...
threadT2 = TsolverThread(
    1, n, Tinit, 0.1, Tsource, 1, 10, 1, 5, threadT1a.myTSolverTransmitter
)
