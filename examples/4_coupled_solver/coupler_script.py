...
import numpy as np
from coupler import EM_T_couplerThread
from coupler import EMsolverSidecarSateliteThread
from coupler import TsolverSidecarSateliteThread
...
thread3Coupling = EM_T_couplerThread(
    threadEM1b.myEMSolverTransmitterSatelite,
    threadT1b.myTSolverTransmitterSatelite,
    "T",
    "SARvol",
    [1, 1, n - 1, n - 1],
    "SARsource",
