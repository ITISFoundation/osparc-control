...
import numpy as np
from EMSolver import EMsolverSidecarThread
from EMSolver import EMsolverThread
...
threadEM2 = EMsolverThread(
    n, EMinit, 1, EMsource, Tinit, 5, 1, 5, threadEM1a.myEMSolverTransmitter
)
